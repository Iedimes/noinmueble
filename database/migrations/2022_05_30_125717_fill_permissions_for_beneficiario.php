...
class FillPermissionsForBeneficiario extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBeneficiario constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.beneficiario',
            'admin.beneficiario.index',
            'admin.beneficiario.create',
            'admin.beneficiario.show',
            'admin.beneficiario.edit',
            'admin.beneficiario.delete',
            'admin.beneficiario.bulk-delete',
        ]);
