...
<br>
<p style="text-align:right;font-size:18px;"><b>NPB {{ $response['cedula'] }}</b></p>
<p style="text-align:center;font-size:30px; font-family:Arial, Helvetica, sans-serif;">CONSTANCIA</p>
<p style="text-align: justify;">Se hace constar que el/la <b>Sr./Sra. {{ $response['titular'] }}
</b>con <b>C.I. N°. {{ $response['cedula'] }} </b>, no registra beneficio a su nombre en los Programas respaldados documental y digitalmente de
